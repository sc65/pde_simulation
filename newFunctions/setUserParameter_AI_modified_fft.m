...
global userParam
%% ----------------- equation parameters.
userParam.Dc = [0.02; 0.4; 0]; % diffusion constants.
...
userParam.sa = 0.1; %random fluctuation, also the rate of self-activation.
userParam.si = 0.1; %rate of  inhibitor activation
...
userParam.kappa = 0.25; % [0 0.25] [spots, stripes]
userParam.basal = [0.0; 0.0; 0]; %basal production rate of components

userParam.initial_values = [3.1; NaN; 0]; % NaN: random value between 0 and 1.
